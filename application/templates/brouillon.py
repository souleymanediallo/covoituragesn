...
# from application.annonces.city import CITY
#
#
...
#     end_city = SelectField('Ville de départ', validators=[InputRequired()],
#                            render_kw={'class': 'form-control form-select js-choice',
#                                       'value': '', 'data-search-enabled': 'true'})
#     profile = RadioField(
#         'Profile',
...
#     start_date = DateField('Date de départ', format='%d %F %Y', validators=[InputRequired()],
#                            render_kw={'class': 'form-control flatpickr flatpickr-input',
#                                       'type': 'date', 'data-date-format': 'd F Y',
...
#                                render_kw={'class': 'form-control'})
#
#     price = IntegerField('Prix', validators=[DataRequired(), NumberRange(min=0, max=50000)])
...
#         self.start_city.choices = [city for city in CITY]
#         self.end_city.choices = [city for city in CITY]
